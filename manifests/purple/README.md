...
Purple contracts and provider tooling must remain compatible with the workspace minimum supported Rust version, currently Rust 1.80. A newer convenience API cannot silently raise the MSRV.
