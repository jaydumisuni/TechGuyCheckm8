...
use tg_usbliter8::{
    finalize_pwn_proof, BoardRunEvidence, HostReconnectAcknowledgement, PwnDfuPlan,
};
use uuid::Uuid;
...
#[test]
fn forged_empty_plan_cannot_produce_verified_pwnd_proof() {
    let plan = PwnDfuPlan {
        session_id: Uuid::new_v4(),
        node_id: "forged-node".to_owned(),
        expected_cpid: "8020".to_owned(),
        firmware_sha256: "not-a-sha256".to_owned(),
        stages: vec![],
